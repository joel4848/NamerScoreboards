package com.joel4848.nicknameseverywhere.command;
...
public class NicknamesEverywhereCommand {
    private static final DynamicCommandExceptionType SET_FAIL = new DynamicCommandExceptionType(o -> Text.translatable("command.nicknameseverywhere.nick.set.fail", o));
    private static final Dynamic2CommandExceptionType SET_FAIL_OTHER = new Dynamic2CommandExceptionType((a, b) -> Text.translatable("command.nicknameseverywhere.nick.set.fail.other", a, b));
    private static final SimpleCommandExceptionType NO_PERMISSION = new SimpleCommandExceptionType(Text.translatable("command.nicknameseverywhere.nick.no.permission"));

    private static final DynamicCommandExceptionType PRONOUNS_SET_FAIL = new DynamicCommandExceptionType(o -> Text.translatable("command.nicknameseverywhere.pronouns.set.fail", o));
    private static final Dynamic2CommandExceptionType PRONOUNS_SET_FAIL_OTHER = new Dynamic2CommandExceptionType((a, b) -> Text.translatable("command.nicknameseverywhere.pronouns.set.fail.other", a, b));
    ...
    public static int setNick(ServerCommandSource source, ServerPlayerEntity target, @Nullable String nick) throws CommandSyntaxException {
        ...
        if (storage == null) {
            var message = Text.translatable("command.nicknameseverywhere.nick.set.fail.unknown");
        ...
        if (nick == null || nickString.isBlank() || parsedNick.equals(target.getName())) {
            ...
            source.sendFeedback(() -> self
                    ? Text.translatable("command.nicknameseverywhere.nick.clear.success")
    ...
    public static int setPronouns(ServerCommandSource source, ServerPlayerEntity target, @Nullable String pronouns) throws CommandSyntaxException {
        ...
        var self = Objects.equals(source.getEntity(), target);
        if (storage == null) {
            var message = Text.translatable("command.nicknameseverywhere.pronouns.set.fail.unknown");
        ...
        if (pronouns == null || pronouns.isBlank()) {
            ...
            source.sendFeedback(() -> self
                    ? Text.translatable("command.nicknameseverywhere.pronouns.clear.success")
