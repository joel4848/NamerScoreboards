...
public class NicknamesEverywhereNicknamePlaceholder extends Placeholder {

    public NicknamesEverywhereNicknamePlaceholder() {
        super("nicknameseverywhere_nickname");
    }
    ...
    public String getDisplayName() {
        return "NicknamesEverywhere Nickname";
    }
